...
public class PlaceBlockCondition extends ProgressTriggerCondition {

    // PLACE_BLOCK 'STONE' '20'
    public PlaceBlockCondition(String symbol, TriggerConditionType type) {
        super("PLACE_BLOCK", TriggerConditionType.PROGRESSIVE);
    }
