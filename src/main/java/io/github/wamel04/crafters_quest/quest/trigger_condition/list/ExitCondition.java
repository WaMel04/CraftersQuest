...
public class ExitCondition extends TriggerCondition {

    // EXIT '-10' 'x' '-10' '10' 'x' '10' 'world'
    public ExitCondition(String symbol, TriggerConditionType type) {
        super("EXIT", TriggerConditionType.COMPLETED_ONCE);
    }
